...
export default function EpisodeRatingsDisplay({
  ...
  return (
    <div className="overflow-x-auto">
      <table className="min-w-full divide-y divide-gray-200 dark:divide-grafite">
        <thead className="bg-gray-50 dark:bg-shadow-gray">
          <tr>
        ...
        <tbody className="bg-white dark:bg-table-row divide-y divide-gray-200 dark:divide-grafite">
