 ...
 * Fetches and combines ratings from multiple providers
 */
...
export async function aggregateRatings(
  ...
  // Step 2: Fetch ratings from all providers in parallel using Promise.allSettled
  ...
  // Step 3: Extract ratings with graceful degradation
  const overall = {
